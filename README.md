# cryptomeme-kitchen
WE NEEDED THAT: pinterest style crypto meme editor ✦ cult templates, drag & drop editor, download & share. xoxo

> browse. edit. download. post. go viral. ✦
...
- 🎰 **crypto vibes** — neon green, glassmorphism, pixel fonts, scrolling ticker, the aesthetic is immaculate
...
drop real images into `public/memes/` matching the filenames in `src/data/memeTemplates.js` and the placeholder gradient cards will automatically be replaced.

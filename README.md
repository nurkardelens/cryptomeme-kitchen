...
<p align="center">
  <img src="./screenshot.png" alt="meme kitchen Screenshot" width="800" />
</p>
...
```bash
git clone https://github.com/YOUR_USERNAME/meme-forge.git
cd meme-forge
npm install
npm run dev
```
...
literally everything is in one file:
